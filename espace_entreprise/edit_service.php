...
if ($_SESSION['garage'] == true ) {
    if(isset($_GET['id'])) {
        $id = $_GET['id'];
        include('function_get_service.php');
...
<head>
    ...
    <title> Édition d'un service| Administrateurs</title>
    <!-- CSS -->
...
if (isset($_POST['title'])) {
    include_once('function_edit_service.php');
    echo editService($id, $service);
    $service = getService($id);
    unset($_POST); 
...
?>
  ...
  <div class="container card-user-modif">
    <div class="header header-management mb-5">
      <h1 class="add-user-title main-title-page"><span style="font-size: 27px;" class="material-symbols-sharp">design_services</span> <a>Édition d'un service</a></h1><br>
        ...
        <input value="<?php echo $service['title'] ?>"  class="form-control" type="text" placeholder="Entrer le nom" name="title" required><br><br>



        <label for="description1">Description 1</label><br>
<textarea  required class="form-control" placeholder="Entrer la description" name="description1" ><?php echo $service['description1'] ?></textarea><br><br>
<label for="description2">Description 2</label><br>
<textarea  class="form-control" placeholder="Entrer la description" name="description2" ><?php echo $service['description2'] ?></textarea><br><br>
<label for="description3">Description 3</label><br>
<textarea   class="form-control" placeholder="Entrer la description" name="description3" ><?php echo $service['description3'] ?></textarea><br><br>
<label for="icone">Icône</label>
        <select id="icon" name="icon" required>
            <option value="" selected ><?php echo $service['icon'] ?></option>
...
<label for="link">Lien (facultatif)</label><br>
        <input value="<?php echo $service['link'] ?>"  class="form-control" type="text" placeholder="Si vous avez une page/article en lien avec" name="link"><br><br>
