...
<head>
    ...
    <title>Édition d'utilisateur | Administrateurs</title>
    <!-- CSS -->
...
if (isset($_POST['email'])) {
    ...
    echo editUser($email_id, $user_edit['email']);
    $user_edit = getUser($email_id);
    unset($_POST);
} 
    ...
    <div class="header header-management mb-5">
                <h1 class="add-user-title main-title-page"><span style="font-size: 27px;" class=" material-symbols-sharp">manage_accounts</span> <a>Édition d'un Utilisateur</a></h1><br>
<form class="form-custom" action="" name="create" method="POST">
  ...
  <label for="lastname">Nom</label><br><input value="<?php echo $user_edit['lastname'] ?>" class="form-control" type="text" placeholder="Entrer le nom" name="lastname" required><br><br>
<label for="firstname">Prénom</label><br><input value="<?php echo $user_edit['firstname'] ?>" class="form-control" type="text" placeholder="Entrer le prénom" name="firstname" required><br><br>


        <label for="email">Identifiant</label><br>
 <input value="<?php echo $user_edit['email'] ?>" class="form-control" type="email" placeholder="Entrer votre email" name="email" required>
 <br><br>
    ...
    <div>
    <input id="inputPassword" class="form-control" type="password" placeholder="Laisser le champ vide pour ne pas modifier le mot de passe" name="password">
